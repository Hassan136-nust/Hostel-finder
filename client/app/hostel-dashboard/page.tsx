...
import { HiOutlineArrowLeft, HiOfficeBuilding } from "react-icons/hi";
      ...
      <div className="min-h-screen flex items-center justify-center flex-col gap-6 px-4">
        <div className="text-center">
          ...
          <p className="text-lg opacity-70">
            You need to be a Hostel Manager to access this page
          </p>
        </div>
        <Link
          href="/"
  ...
  return (
    <div className="min-h-screen pt-8 md:pt-16 pb-16 px-4 md:px-6">
      <div className="max-w-4xl mx-auto">
        ...
        >
          <div className="w-24 h-24 mx-auto mb-6 rounded-full bg-gradient-to-r from-emerald-500/20 to-teal-600/20 flex items-center justify-center">
            <HiOfficeBuilding size={48} className="text-emerald-500" />
          </div>
          <h1 className="text-3xl md:text-4xl font-bold mb-4">Hostel Dashboard</h1>
          <p className="text-lg opacity-70 max-w-md mx-auto mb-8">
            Welcome, {user.name}! This is where you will manage your hostel listings and bookings.
          </p>
          <div className="inline-block px-6 py-3 rounded-full bg-emerald-500/20 text-emerald-600 dark:text-emerald-400 font-medium">
            Coming Soon
          </div>
        </motion.div>
      </div>
